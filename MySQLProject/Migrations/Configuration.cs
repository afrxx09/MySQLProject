namespace MySQLProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MySQLProject.DAL.MyDbContext>
    {
        ...
        protected override void Seed(MySQLProject.DAL.MyDbContext context)
        {
